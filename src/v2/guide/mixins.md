...
Par exemple,  dans le cas où les données d'un mixin subissent une fusion (une propriété profonde) avec les données d'un composant, ce sont les données du composant qui vont prendre la priorité en cas de conflits.
